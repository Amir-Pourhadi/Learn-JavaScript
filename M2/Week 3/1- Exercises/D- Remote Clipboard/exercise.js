...
const clipboardTitle = "myClipboardId";
const clipboardText = "some text to put in the clipboard";
const requestBody = { title: clipboardTitle, text: clipboardText };
...
fetch("https://codeyourfuture.herokuapp.com/api/clipboard?title=myClipboardId")
  ...
  .then((clipboard) => console.info(clipboard))
