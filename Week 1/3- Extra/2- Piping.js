...
const badCode = format(multiply(add(startingValue, 10), 2));

/* BETTER PRACTICE */
//* Readable
//* Debugging

const addNums = add(startingValue, 10);
const multiplyNums = multiply(addNums, 2);
const formatNums = format(multiplyNums);
const goodCode = formatNums;
